...
\begin{figure}
\centering
\includegraphics[width=4in]{Proxemics.jpg}
\caption{Typical use of the social interaction assistant, a third person perspective on the use case scenario.}
\label{TIMFigure119}
\end{figure}
...
\section{Dyadic Interaction Assistant}
...
\chapter{Delivering Facial Expressions through Auxiliary Modalities}
