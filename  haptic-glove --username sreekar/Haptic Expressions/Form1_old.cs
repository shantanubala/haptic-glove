...
namespace Haptic_Expressions
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            SW.WriteLine(ResponseTime.Duration().Milliseconds.ToString());
            SW.Flush();
        ...
        private void LoadMotorTimes()
        {
            ...
            SurpriseTimes = new int[15] { 
                OnTime * 4/10, TimeBWMotors, 
                OnTime *3/10, 0,// TimeBWMotors, 
                OnTime *4/10, 0,//, TimeBWMotors,
                OnTime * 3/10, 0,//, TimeBWMotors, 
                OnTime *4/10, 0,//, TimeBWMotors,
                OnTime * 3/10, 0,//, TimeBWMotors,
                OnTime * 4/10, 0,//, TimeBWMotors,
