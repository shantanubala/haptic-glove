...
\item \emph{Ability to switch between subject-dependent and subject-independent facial expression recognition:} Social interactions vary between personal interactions with friends and family to professional meetings with strangers that the user may meet only once. 
\end{itemize}

\section{Temporal Exampler-based Bayesian Network for Facial Expression \& Gesture Sensing}
In the 

\begin{figure}
\centering
\includegraphics[width=3in]{FaceAPIPoints.JPG}
