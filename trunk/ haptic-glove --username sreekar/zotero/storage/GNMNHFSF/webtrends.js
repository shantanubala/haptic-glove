...
function WebTrends(){
	...
	this.timezone=-5;
	this.fpcdom="";
	this.onsitedoms="blog-msb.embo.org, blogs.nature.com, cmckb.cellmigration.org, connotea.org, functionalglycomics.com, go.nature.com, guide.labanimal.com, kb.psi-structuralgenomics.org, lipidmaps.org, nature.com, natureasia.com, naturechina.com.cn, network.nature.com, network.nature.com, neuroscience-gateway.org, pid.nci.nih.gov, precedings.nature.com, scintilla.nature.com, secure.nature.com, signaling-gateway.org, spotlight.nature.com, npg.nature.com, press.nature.com , palgrave-connect.com, www.cellmigration.org, www.connotea.org, www.econolog.net, www.functionalglycomics.org, www.labanimal.com, www.lipidmaps.org, www.nature.com, www.natureasia.com, www.neuroscience-gateway.org, www.palgrave-journals.com, www.rikenresearch.riken.jp, www.rikenresearch.riken.jp, www.scitable.com, www.signaling-gateway.org";
	this.downloadtypes="xls,doc,pdf,txt,csv,zip,mp3,mp4,mov,AVI,bin,bmp,BMP,cdx,cml,CSS,css,dat,db,exe,Exe,GIF,gif,gz,HTM,jar,java,jpg,mol,pkg,png,ppt,psd,rss,sgml,tab,TAB,tgz,ttf,TXT,utf,xml,rdf";
	...
	if (evt&&((typeof(evt.which)!="number")||(evt.which==1))){
		...
		if (e.href){
		    ...
		    if (this.dcsIsOnsite(hn)&&this.dcsTypeMatch(e.pathname,this.downloadtypes)){
		        ...
		        this.DCS.dcssip=this.DCS.dcsuri=this.DCS.dcsqry=this.WT.ti=this.WT.dl=this.WT.nv=WT.ndl="";
		    }
		}
	}
}
